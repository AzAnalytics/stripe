...
class _HomePageState extends State<HomePage> {
    ...
    return StreamBuilder<User?>(
      ...
      builder: (context, authSnapshot) {
        if (!authSnapshot.hasData) {
          return const LoginPage(); // ✅ Redirection propre vers la page de connexion
        }
          ...
          builder: (context, userSnapshot) {
            ...
            return FutureBuilder<StripeData>(
              ...
              builder: (context, stripeSnapshot) {
                ...
                StripeData stripeData = stripeSnapshot.data!;
                ...
                return StreamBuilder<SubscriptionStatus>(
                  ...
                  builder: (context, subSnapshot) {
                    ...
                    SubscriptionStatus? subscriptionStatus = subSnapshot.data;
                    ...
                    return Scaffold(
                      ...
                      appBar: AppBar(
                        ...
                        actions: [
                          TextButton(
                            onPressed: () => logoutUser(context), // ✅ Correction de la fonction de déconnexion
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (subscriptionStatus != null &&
                              ...
                              subscriptionTile('Starter Plan', '80.00 €', stripeData.sub1priceId, subscriptionStatus),
                            const SizedBox(height: 10),
                            if (subscriptionStatus != null &&
                                (!subscriptionStatus.subIsActive ||
                                    subscriptionStatus.activePriceId == stripeData.sub2priceId))
                              subscriptionTile('Pro Plan', '120.00 €', stripeData.sub2priceId, subscriptionStatus),
  ...
  void logoutUser(BuildContext context) async {
    ...
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (context) => const LoginPage()), // ✅ Redirection propre vers LoginPage
          (Route<dynamic> route) => false, // ✅ Supprime tout l’historique de navigation
    );
  }

  /// 🔥 Met à jour `subscriptionTile` pour recevoir `subscriptionStatus`
  Widget subscriptionTile(String title, String price, String priceId, SubscriptionStatus subscriptionStatus) {
    return Padding(
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  SizedBox(width: 2),
                  Text(
                    'Accès illimité - Annulation à tout moment',
              ...
              ElevatedButton(
                ...
                onPressed: subscriptionStatus.subIsActive ? customerPortal : () => checkoutProcess(title),
                child: Text(
                  subscriptionStatus.subIsActive ? 'Gérer l\'abonnement' : 'Choisir ce plan',
